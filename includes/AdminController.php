...
final class AdminController
{
    ...
    {
        $this->guard();$totals=$this->repository->attendanceTotals();echo '<div class="wrap"><h1>'.esc_html__('Check-in & Attendance','dizzy-reservations-manager').'</h1>'.$this->cards(['Confirmed reservations'=>$totals['confirmed_reservations'],'Expected guests'=>$totals['confirmed_guests'],'Checked-in reservations'=>$totals['checked_in_reservations'],'Guests attended'=>$totals['checked_in_guests']]); ?>
