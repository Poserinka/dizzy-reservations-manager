...
final class AdminController
{
    ...
    {
        $this->guard();$totals=$this->repository->attendanceTotals();echo '<style>.notice.notice-info{display:none!important}</style><div class="wrap"><h1>'.esc_html__('Check-in & Attendance','dizzy-reservations-manager').'</h1>'; ?>
