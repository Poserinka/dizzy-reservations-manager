...
final class TicketExperience
{
    ...
    public function details(): void
    {
        ...
        wp_send_json_success([
            ...
            'date' => $timestamp !== false ? wp_date(get_option('date_format') . ' â€“ ' . get_option('time_format'), $timestamp, wp_timezone()) : $start,
    ...
    public function render(): void
    {
        ...
        ?>
        <style>
            .dizzy-ticket-overlay{align-items:center;background:rgba(8,12,18,.78);display:none;inset:0;justify-content:center;padding:18px;position:fixed;z-index:999999}.dizzy-ticket-overlay.is-open{display:flex}.dizzy-ticket-modal{background:#fff;border-radius:14px;box-shadow:0 24px 70px rgba(0,0,0,.35);box-sizing:border-box;color:#17202a;max-height:92vh;max-width:540px;overflow:auto;padding:30px;position:relative;text-align:center;width:100%}.dizzy-ticket-close{background:transparent!important;border:0!important;color:#17202a!important;font-size:28px!important;line-height:1!important;padding:8px!important;position:absolute;right:10px;top:8px}.dizzy-ticket-modal img{height:auto;max-width:280px;width:72%}.dizzy-ticket-actions{display:flex;flex-wrap:wrap;gap:10px;justify-content:center;margin-top:22px}.dizzy-ticket-actions button,.dizzy-ticket-actions a{border:1px solid #3155df;border-radius:5px;box-sizing:border-box;padding:11px 18px;text-decoration:none}.dizzy-ticket-primary{background:#3155df!important;color:#fff!important}.dizzy-ticket-back{background:#fff!important;color:#3155df!important}.dizzy-ticket-meta{line-height:1.7;margin:18px 0}.dizzy-ticket-loader{padding:45px 10px}@media(max-width:600px){.dizzy-ticket-modal{padding:28px 18px}.dizzy-ticket-actions>*{width:100%}}
        </style>
